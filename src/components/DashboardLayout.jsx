            ...
            >
                ...
                <nav className="flex-1 overflow-y-auto px-2 pb-4 space-y-1 mt-2">
                    ...
                    <div className="pt-4">
                        ...
                        <SidebarItem
                            to="/done/aml-investigation"
                            icon={<Activity />}
                            label="AML Investigation"
                            isActive={location.pathname.includes('aml-investigation') || isProcessDetailPage}
                        />
                    </div>
                    ...
                    <div className={`flex items-center gap-3 transition-opacity duration-150 ${!isSidebarOpen ? 'pl-8' : ''}`}>
                        <div className="flex items-center gap-2 text-[13px]">
                            {location.pathname.includes('/knowledge-base') ? (
                                <>
                                    <button onClick={() => navigate('/done/aml-investigation')} className="hover:bg-white rounded p-1 transition-colors">
                                        <ArrowLeft className="w-3.5 h-3.5 text-[#171717]" />
                                    </button>
                                    <span className="text-[#8f8f8f] font-normal">AML Investigation /</span>
                                ...
                                <>
                                    ...
                                    <span className="text-[#171717] font-[550]">AML Investigation</span>
